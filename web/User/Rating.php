    	...
    	<div class="card">
    		...
    		<div class="card-body">
    			<div class="row">
    				...
    				<div class="col-sm-4 text-center">
                        <?php
                        $selRating="select * from tbl_userfeedbacktoshop where user_id=".$_SESSION['user_id']." and product_id=".$_GET['pid'];
                        $resRating=$con->query($selRating);
                        if($resRating->fetch_assoc())
                        {
                        ?>
    					<h3 class="mt-4 mb-3">Your Feedback has been Recorded</h3>
                        <?php
                        }
                        else{
                            ?>
    ...
    $('#save_review').click(function(){
        ...
        else
        {
            $.ajax({
                ...
                method:"POST",
                data:{rating_data:rating_data, user_review:user_review, tool_id:tool_id},
